    ...
    <div className="FoodSecurityTableau">
      ...
      >
        ...
        <g id="Base_Layers" data-name="Base Layers" opacity=".9">
          ...
          {/* <path id="Water_BG_Start" data-name="Water BG Start" class="cls-7" d="M1051.3 355.1l-166.4.5-85.8-2.5-108.7-6.1-59.1-6.8a60.7 60.7 0 00-6.1 1.8c-12.9 4.5-25.4 4-38.5 3.7-9.5-.2-19.1.3-28.7.3-22.3 0-44.3 3-66.4 4.7-24.4 1.8-48.7 1-73 .8-39.6-.3-79 .7-118.6 3.7-8.7.7-17.3.2-25.8 3.8-10.1 4.3-19.8 3-30 2.7-12.4-.4-24.8.9-37.1 1.6-17.2 1-34 4-50.8 7.6C104.3 382.2 52.8 395 0 403.4v139.8h1963V354.4z" transform="translate(0 -24.2)"/>
    <path id="Groundwater_Start" data-name="Groundwater Start" class="cls-8" d="M928.3 519H1963V330.2l-911.7.8-166.4.4-85.8-2.5-108.7-6.1-59.1-6.8 39.5 52.9 26 26.9 35.5 28.1 25.9 15.8 24.2 11.2L928.3 519z"/>
